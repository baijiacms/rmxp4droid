...
package com.music.de.jarnbjo.flac;

import java.io.*;
import java.util.*;

import com.music.de.jarnbjo.ogg.*;
import com.music.de.jarnbjo.util.io.*;



public class FlacStream {

	public long getCurrentGranulePosition(){return oggStream.getTime();}
